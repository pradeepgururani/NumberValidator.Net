...
namespace NumberValidator.Tests.NO.Fodselnummer
{
    public class FodselnummerFixture
    {
       ...
       => _sut.CheckDigit2("15108695088").Should().Be(8);
        ...
        [Fact]
        void futuredateWillBeInValid()
      => _sut.BirthYear("15103495077").Should().Be(2034);

        [Fact]
        void PastDataWillBeInvalid()
     => _sut.BirthYear("15105595077").Should().Be(1955);

        [Fact]
        void PastDateWillBeValid()
     => _sut.BirthdateInFuture("15105595077").Should().BeFalse();

        [Fact]
        void Indivilualdigitlesstha500()
     => _sut.BirthYear("15102435077").Should().Be(1924);

        [Fact]
        void yearGreaterThan54()
     => _sut.BirthYear("15105765077").Should().Be(1857);
