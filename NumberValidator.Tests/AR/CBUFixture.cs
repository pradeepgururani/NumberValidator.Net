...
namespace NumberValidator.Tests.AR
{
    ...
    { 
        ...
        [Fact]
        void ShouldBeInvalidForAlphabet()
          => Assert.Throws<InvalidFormatException>(() => _sut.ValidateFormat("28A59084009041813H5201"));
        ...
        [Fact]
        void ShouldBeInalid()
            => _sut.IsValid("285059-094009041813501").Should().BeFalse();
            
        [Fact]
        void ShouldBeInalidForMidtyping()
            => _sut.IsValid("2850a09400904c813501").Should().BeFalse();
