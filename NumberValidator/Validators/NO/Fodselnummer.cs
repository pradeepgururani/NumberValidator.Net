...
// F�dselsnummer (Norwegian birth number, the national identity number).
// The F�dselsnummer is an eleven-digit number that is built up of the date of
...
namespace NumberValidator.Validators.NO
{
    public class FSN : IValidator
    {
        ...
        public int BirthYear(string fsn)
        {
            ...
            else if (individual_digits >= 500 && individual_digits < 750 && year > 54)
            {
                year = year + 1800;
            }

            else if (individual_digits < 1000 && year < 40)
            {
                year = year + 2000;
            }
        ...
        public bool BirthdateInFuture(string fsn)
        {
            ...
            var dob = new DateTime(BirthYear(fsn), month, day);
